...
```{r}
df_nodesamp_runs = read_csv('/Users/georgeberry/Dropbox/project-autocorr/data/nodesamp_runs.csv')
df_edgesamp_runs = read_csv('/Users/georgeberry/Dropbox/project-autocorr/data/edgesamp_runs.csv')
```
