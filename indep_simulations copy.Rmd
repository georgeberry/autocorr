...
```{r}
df_nodesamp_runs = fn_par_bootstrap(fn_oos, 500, fn_dgp_corr_indep_nodesamp) 
write_csv(
  df_nodesamp_runs,
...
```{r}
df_edgesamp_runs = fn_par_bootstrap(fn_oos, 500, fn_dgp_corr_indep_edgesamp)
write_csv(
  df_edgesamp_runs,
...
```{r}
df_nodesamp_runs = read_csv('/Users/georgeberry/Dropbox/project-autocorr/data/nodesamp_indep_runs.csv')
df_edgesamp_runs = read_csv('/Users/georgeberry/Dropbox/project-autocorr/data/edgesamp_indep_runs.csv')
```
